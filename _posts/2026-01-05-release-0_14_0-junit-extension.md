...
The Junit 5 Extension uses Testcontainers to create broker instances for your Junit tests (when you choose [container-based provisioning](https://github.com/kroxylicious/kroxylicious-junit5-extension/blob/main/README.md#choosing-the-provisioning-mechanism)).

...
- **Replication factor**: the encryption numbers assume traffic isn't already hitting Kafka's own replication limits — the [companion post]({% post_url 2026-06-04-benchmarking-the-proxy-under-the-hood %}) explains why that matters.
